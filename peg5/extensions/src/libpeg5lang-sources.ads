...
package LibPeg5lang.Sources is
   ...
   --  LibPeg5lang.Lexer.Invalid_Input if Pattern is invalid.
   ...
   --  Raise a LibPeg5lang.Common.Property_Error if Text is not a valid
   --  literal.
   ...
   --  a LibPeg5lang.Common.Property_Error if Text is not a valid literal.
   ...
   --  (arbitrary precision). Raise a LibPeg5lang.Analysis.Property_Error if
