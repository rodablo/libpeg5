...
--  end read only
   ...
   begin
      ...
      --  AUnit.Assertions.Assert
      --    (Gnattest_Generated.Default_Assert_Value,
      --     "Test_Some_Other_Func_upper_boundest not implemented.");
...
--  end read only
   ...
   begin
      ...
      --  AUnit.Assertions.Assert
      --    (Gnattest_Generated.Default_Assert_Value,
      --     "Test_Some_Other_Func_lower_boundest not implemented.");
...
--        --  AUnit.Assertions.Assert
--        --    (Gnattest_Generated.Default_Assert_Value,
--        --     "Test_Some_Op_some_op_aux_2est not implemented.");
--  
--  begin read only
